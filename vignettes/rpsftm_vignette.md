...
```
#> Warning in rpsftm(formula = ReCen(progyrs, censyrs) ~ Instr(imm, rx), data = immdef, : 
...
#> = immdef, : Evaluation of a limit of the Confidence Interval failed. It is
#> set to NA
#> rpsftm(formula = ReCen(progyrs, censyrs) ~ Instr(imm, rx), data = immdef, 
#>     low_psi = 1, hi_psi = 2)
#> NULL
#> 
#> psi: NA
...
![](rpsftm_vignette_files/figure-html/unnamed-chunk-6-1.png)<!-- -->
